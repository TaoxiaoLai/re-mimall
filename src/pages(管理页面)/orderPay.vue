        ...
        <div class="order-wrap">
          <div class="item-order">
            ...
            <div class="order-info">
              <h2>订单提交成功!去付款咯~</h2>
              <p>请在<span>30分</span>内完成支付，超时将取消订单</p>
              <p>收货信息：{{addressInfo}}</p>
            </div>
            <div class="order-total">
              <p>应付总额：<span>{{payment}}</span>元</p>
              <p>订单详情<em class="icon-down" :class="{'icon-up':showDetail}" @click="showDetail = !showDetail"></em></p>
            </div>
          </div>
              ...
              <div class="detail-info">
                <ul>
                  <li v-for="(item, index) in orderDetail" :key="index">
                    <img v-lazy="item.productImage"/>{{item.priductName}}
                  </li>
                </ul>
              </div>
            </div>
